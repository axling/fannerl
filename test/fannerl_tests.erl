...
fannerl_scale_and_descale_train(_) ->
    ?_test(
	   ...
	   ScaledInput = fannerl:scale_input(R, {1.5,1.3}),
	   ScaledOutput = fannerl:scale_output(R, {1}),
	   {1.5,1.3} =:= fannerl:descale_input(R, ScaledInput),
	   {1.0} =:= fannerl:descale_output(R, ScaledOutput),
